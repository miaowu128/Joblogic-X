...
Workflow for auto-coaching mode
...
Workflow for rule-based-coaching mode
Competition Mode 
...
Score	Round 1	Round 2	Round 3	Round 4	Round 5	Avg score
Good Student 1	77	51	40	72	69	62
Good Student 2	37	63	41	90	42	55
Bad Student 1	45	26	31	51	77	46
Bad Student 2	53	65	46	41	36	48
...
Acknowledgment
This report and the research behind it would not have been possible without the exceptional support of my supervisor, Tara Su and Emma. Their enthusiasm, knowledge and exacting attention to detail have been an inspiration and kept my work on track from my first encounter with this computer vision project. 
References
...
Annex
Appendix A – Code
Our code is located at https://github.com/DS-XL/CV_2022_cohort1/tree/group2
